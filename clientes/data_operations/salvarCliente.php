...
class salvarCliente{
    ...
    function __construct($id,$nome,$email,$telefone){
        ...
        if ($id==""){
            ...
            $this->atualizaCliente($id, $nome, $email, $telefone);
    ...
    private function adicionaCliente($nome,$email,$telefone){
        ...
        $url = "https://rtumliswsljprclempsj.supabase.co/rest/v1/rpc/CriaCliente";
    ...
    private function atualizaCliente($id,$nome,$email,$telefone){

        $url = "https://rtumliswsljprclempsj.supabase.co/rest/v1/rpc/AtualizaCliente";
    
        $data = array("newid" => $id, "newnome" => $nome, "newemail" => $email, "newtelefone" => $telefone);
